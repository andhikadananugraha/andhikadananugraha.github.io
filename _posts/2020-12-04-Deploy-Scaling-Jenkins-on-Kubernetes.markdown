...
```
sudo docker build -f Dockerfile-jenkins-master -t andhikadananugraha/jenkins-master-scaling .
sudo docker push andhikadananugraha/jenkins-master-scaling:latest
```
  ...
  template:
    ...
    spec:
      ...
      - env:
        ...
        name: jenkins
        image: andhikadananugraha/jenkins-master-scaling
